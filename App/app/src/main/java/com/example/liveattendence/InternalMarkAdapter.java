...
public class InternalMarkAdapter extends RecyclerView.Adapter<InternalMarkAdapter.MyViewHolder> {
    ...
    String sNamer[],semNamer[],snameid[],semNameid[];
    Context context;

     static OnItemClickListener itemClickListener;

    public InternalMarkAdapter(Context ct, String[] subjectname,String[] subjectid,String[] semestername,String[] semesterid) {
        context = ct;
        sNamer = subjectname;
        snameid =subjectid;
