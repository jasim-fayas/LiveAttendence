...
public class View_InternalMark extends AppCompatActivity {
    ...
    String subjectname[], subjectid[], semestername[], semesterid[];
    ...
    public class subjectsview extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            InternalMarkAdapter internalMarkAdapter = new InternalMarkAdapter(View_InternalMark.this, subjectname, subjectid, semestername, semesterid);
