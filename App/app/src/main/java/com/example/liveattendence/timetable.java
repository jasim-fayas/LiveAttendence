...
public class timetable extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mondayhour1 = findViewById(R.id.textViewHour1);
        mondayhour2 = findViewById(R.id.textViewHour2);
        mondayhour3 = findViewById(R.id.textViewHour3);
        mondayhour4 = findViewById(R.id.textViewHour4);
        mondayhour5 = findViewById(R.id.textViewHour5);
    ...
    public class timetabledetails extends AsyncTask<String, String, String>{
        ...
        protected void onPostExecute (String s){
            super.onPostExecute(s);
              Toast.makeText(timetable.this, s, Toast.LENGTH_LONG).show();
            ...
            if (!s.equals("[]")) {
                ...
                try {
                    ...
                    Day = fo.getString("name");
                    Hour = fo.getString("hour");
                    Sname = fo.getString("sname");
                    Cname = fo.getString("cname");
