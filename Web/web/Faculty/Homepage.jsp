  ...
  <header class="main-header clearfix" role="header">
    ...
    <nav id="menu" class="main-nav" role="navigation">
        <ul class="main-menu">
            ...
            <li><a href="AllottedHours.jsp">Time Table</a></li>
            <!-- New dropdown list -->
            <li class="has-submenu"><a href="#section7">Attendance</a>
                <ul class="sub-menu">
                    <li><a href="ViewTimeTable.jsp">Student TT</a></li>
                    <li><a href="Attendence.jsp">Attendance</a></li>
                    <li><a href="ViewLeaveApplications.jsp">Leave</a></li>
                    <li><a href="AssignedSubject.jsp">Internal mark</a></li>
                </ul>
            </li>
  ...
  <section class="section main-banner" id="top" data-section="section1">
      ...
      <div class="video-overlay header-text">
          <div class="caption">
              ...
              String sel = "select * from tbl_faculty q inner join tbl_department p on q.department_id=p.department_id inner join tbl_department_type r on p.department_type_id=r.department_type_id where q.faculty_id='"+pid+"' and p.department_id='"+did+"' ";
              ResultSet tr = con.selectCommand(sel);
              tr.next();
              
              
              %>
              <h2> Faculty <em><%=tr.getString("faculty_name")%></em> </h2>
