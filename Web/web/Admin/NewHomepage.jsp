    ...
    <body class="crm_body_bg">
        ...
        <nav class="sidebar">
            <div class="logo d-flex justify-content-between">
                <a href="index.html"><img src="../Assets/Template/Admin/img/logo.png" alt=""></a>
                                ...
                                <div class="staf_list_wrapper sraf_active owl-carousel">
                                    ...
                                    <div class="single_staf">
                                        <div class="staf_thumb">
                                            <img src="../Assets/Template/Admin/img/staf/1.png" alt="">
                                        </div>
                                    ...
                                    <div class="single_staf">
                                        <div class="staf_thumb">
                                            <img src="../Assets/Template/Admin/img/staf/2.png" alt="">
                                        </div>
                                        <h4>Dr. Sysla J Smith</h4>
                                        <p>Doctor</p>
                                    </div>
