  ...
  <header class="main-header clearfix" role="header">
    ...
    <nav id="menu" class="main-nav" role="navigation">
        <ul class="main-menu">
            ...
            <li><a href="ViewTimeTable.jsp">Time Table</a></li>
          
            <!-- New dropdown list -->
            <li class="has-submenu"><a href="#section7">Complaint & Attendance</a>
                <ul class="sub-menu">
                    <li><a href="Complaint.jsp">Complaint</a></li>
                    <li><a href="AnonymousComplaint.jsp">Anonymous Complaint</a></li>
                    <li><a href="ApplyForLeave.jsp">Leave</a></li>
      ...
      <div class="video-overlay header-text">
          <div class="caption">
              <h6>Indira Gandhi Group Of Institution</h6>
                <%
              String pid = session.getAttribute("studentid").toString();
            
                       String did = session.getAttribute("departmentid").toString();
              
              String sel = "select * from tbl_student q inner join tbl_department p on q.department_id=p.department_id inner join tbl_department_type r on p.department_type_id=r.department_type_id where q.student_id='"+pid+"' and p.department_id='"+did+"' ";
              ResultSet tr = con.selectCommand(sel);
              tr.next();
              
              
              %>
              <h2> Student <em><%=tr.getString("student_name")%></em> </h2>
      ...
      <div class="row">
        <div class="col-md-7 col-xs-12">
          <div class="continer centerIt">
            <div>
              <h4>Take <em>any online course</em> and win scholarship</h4>
              <div class="counter">
