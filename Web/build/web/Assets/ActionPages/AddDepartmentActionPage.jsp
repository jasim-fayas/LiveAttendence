...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../Admin/AddDepartment.jsp'
    }, 40);//40millisecend it go to next page
</script>
<%
} else {
    String InsQry = "insert into tbl_department(department_type_id,department_email,department_contact,department_photo,department_landmark,department_password)"
            + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + photo + "','" + value[3] + "','" + value[4] + "')";
