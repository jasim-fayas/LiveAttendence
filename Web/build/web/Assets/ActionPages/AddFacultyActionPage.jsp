...
//                        }
        ...
        String select = "select * from tbl_faculty where faculty_email='" + value[2] + "'";
...
<script type="text/javascript">
    ...
    setTimeout(function() {
        window.location.href = '../../Admin/AddFaculty.jsp'
    }, 40);//40millisecend it go to next page
</script>
<%
} else {
    String InsQry = "insert into tbl_faculty(faculty_name,faculty_contact,faculty_email,faculty_photo,faculty_address,place_id,faculty_gender,faculty_dob,faculty_about,faculty_password,department_id)"
