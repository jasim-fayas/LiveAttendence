...
public final class TimeTable_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (request.getParameter("btn_reset") != null) {
      ...
      out.write("<script>\n");
      out.write("    function submitTimetable(hour,cid, semester, subject, day) {\n");
      out.write("        $.ajax({\n");
      ...
      out.write("                window.location = 'TimeTable.jsp?sel_course='+cid+'&sel_semester=' + semester + '&btn_submit=Submit';\n");
      out.write("            }\n");
      out.write("        });\n");
      out.write("    }\n");
      out.write("</script>\n");
