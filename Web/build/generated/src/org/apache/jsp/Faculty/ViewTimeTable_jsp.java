...
public final class ViewTimeTable_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (request.getParameter("btn_reset") != null) {
      ...
      out.write("            <tr>\n");
      out.write("                <td colspan=\"2\">Time Table</td>\n");
      ...
      out.write("                    ");
                        ...
                        String selQry1 = "SELECT * FROM tbl_timetable t INNER JOIN tbl_subject s ON t.subject_id = s.subject_id WHERE timetable_day='" + day + "' AND timetable_hour='" + i + "' AND s.semester_id='" + semester + "'";
